...
#import data
with open('/Users/jasonserviss/Github/sp.scRNAseq/inst/pythonTmp/syntheticMean.txt') as f:
    cellTypes = pd.read_table(f, sep='\t', index_col=0, header=0, lineterminator='\n')

with open('/Users/jasonserviss/Github/sp.scRNAseq/inst/pythonTmp/syntheticMultuplets.txt') as f:
...
df.to_csv("~/Desktop/syntheticOptResults.txt", sep='\t')
