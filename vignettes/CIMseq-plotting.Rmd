...
Edge bar graph.
```{r}
plotSwarmEdgeBar(CIMseqSwarm_test, CIMseqSinglets_test)
```

P-value bar graph.
```{r}
plotSwarmPbar(CIMseqSwarm_test, CIMseqSinglets_test)
```

Heatmap.
```{r}
plotSwarmHeat(CIMseqSwarm_test, CIMseqSinglets_test)
```
