...
```{r, fig.align='center', fig.height=8, fig.width=10, eval=FALSE, message=FALSE}
...
```{r, fig.align='center', fig.height=8, fig.width=10, eval=FALSE, message=FALSE, warning=FALSE}
plotSwarm(sObj, uObj, cObjSng, type="igraph", edge.cutoff=1/10.5, min.num.edges=1)
```
