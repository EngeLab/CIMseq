...
```{r}
path <- system.file('rawData/testCounts.txt', package = "sp.scRNAseq")
testCounts <- as.matrix(read.table(path, header = TRUE, row.names = 1))
...
Several other plotting options exist such as:
