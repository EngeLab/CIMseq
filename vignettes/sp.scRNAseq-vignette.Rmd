...
```{r, fig.align='center', fig.height=8, fig.width=10, eval=TRUE, message=FALSE}
plotCountsMarkers(cObjSng, cObjMul, markers = c("c1", "b1"))
```
...
```{r, fig.align='center', fig.height=8, fig.width=10, eval=TRUE, message=FALSE}
plotUnsupervisedMarkers(uObj, cObjSng, markers = c("c1", "b1"))
```
...
sObj <- spSwarm(
  cObjMul, uObj, distFun = "dtsnCellNum", swarmsize = 150, cores = 2,
  maxiter = 10, cellNumbers = cellNrs, e = 0.0025
)
```
