...
#' @export
normalizeFractionsEigen <- function(fractions) {
    .Call('_sp_scRNAseq_normalizeFractionsEigen', PACKAGE = 'sp.scRNAseq', fractions)
}
...
#' @author Jason T. Serviss
#' @export
sampleSingletsEigen <- function(classes) {
    .Call('_sp_scRNAseq_sampleSingletsEigen', PACKAGE = 'sp.scRNAseq', classes)
}
...
#' @author Jason T. Serviss
#' @export
adjustAccordingToFractionsEigen <- function(fractions, subMat) {
    .Call('_sp_scRNAseq_adjustAccordingToFractionsEigen', PACKAGE = 'sp.scRNAseq', fractions, subMat)
}
...
#' @author Jason T. Serviss
#' @export
poissonSampleEigen <- function(rsRcpp) {
    .Call('_sp_scRNAseq_poissonSampleEigen', PACKAGE = 'sp.scRNAseq', rsRcpp)
}
...
#' @author Jason T. Serviss
#' @export
cpmEigen <- function(counts) {
    .Call('_sp_scRNAseq_cpmEigen', PACKAGE = 'sp.scRNAseq', counts)
}
